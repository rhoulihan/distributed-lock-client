 ...
 */
public class MongoDBLockItem extends LockItem {
    private final MongoDBLockClient client;
    private final String lockKey;

    /**
     * Creates a MongoDB lock item representing a given key. This constructor should
     ...
     * package-private.
     *
     * @param client                        The MongoDBLockClient object associated with this lock
     ...
     *                                      the lock
     */
    MongoDBLockItem(final MongoDBLockClient client, final String key, final Optional<ByteBuffer> data, final boolean deleteLockItemOnClose,
        ...
        final Optional<SessionMonitor> sessionMonitor, final Document additionalAttributes) {
    ...
    public String toString() {
        String dataString = this.data
            ...
            .orElse("");
        return String
            .format("LockItem{Lock Key=%s, Owner Name=%s, Lookup Time=%d, Lease Duration=%d, "
                    + "Record Version Number=%s, Delete On Close=%s, Data=%s, Is Released=%s}",
                this.lockKey, this.ownerName, this.lookupTime.get(), this.leaseDuration.get(), this.recordVersionNumber, this.deleteLockItemOnClose,
    ...
    @Override
    public int hashCode() {
        return Arrays.hashCode(Arrays.asList(this.lockKey, this.ownerName).toArray());
    }
    ...
    public boolean equals(final Object other) {
        ...
        return this.lockKey.equals(otherLockItem.getPartitionKey()) && this.ownerName.equals(otherLockItem.getOwnerName());
    }
